...
func (m *MockStore) GetTransaction(ctx context.Context, id int64) (db.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(ctx context.Context, arg db.CreateTransactionParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
